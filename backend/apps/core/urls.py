...
urlpatterns = [
    ...
    path('studio/video-prompt/', views.studio_video_prompt),
    ...
    path('studio/thumbnail-benchmark/', views.studio_thumbnail_benchmark),
    path('studio/thumbnail-benchmark/job/<str:task_id>/', views.studio_thumbnail_benchmark_job_status),
]
